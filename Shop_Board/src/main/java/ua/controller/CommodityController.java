...
public class CommodityController {
	...
	@RequestMapping(value="/admin/commodity/update/{id}")
	...
	public String delete(@PathVariable int id,
		...
		return "redirect:/admin/commodity"+getParams(pageable, form);
	}
