...
<div class="row-fluid">
		...
		<div class="container-fluid">
			<div class="collapse navbar-collapse" id="">
				<ul class="nav navbar-nav">
					<li class="active"><a href="/user/commodity">Add
							commodity</a><span class="sr-only">(current)</span></li>
					<li><a href="/">Home</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="col-md-3 col-xs-12">
		<div class="col-md-12 col-xs-12">
			<form:form action="/user/commodity" class="form-inline" method="get"
	...
	<form:form action="/user/commodity" method="post" modelAttribute="form"
		...
		<custom:hiddenInputs
			excludeParams="id, title, price, count, discription, path, version, category" />
		<div class="form-group">
			...
			<form:textarea path="discription" id="discription" class="form-control"
				rows="1" cols="107" placeholder="Discription" /><br><br>
	...
	<c:forEach items="${page.content}" var="commodity">
		<div class="row">
			...
			<div class="col-sm-3">
				<h4>
					<a href="/user/commodity/delete/${commodity.id}<custom:allParams/>">delete</a>
				</h4>
			</div>
			<div class="col-sm-3">
				<h4>
					<a href="/user/commodity/update/${commodity.id}<custom:allParams/>">update</a>
				</h4>
			</div>
		</div>
	</c:forEach>
